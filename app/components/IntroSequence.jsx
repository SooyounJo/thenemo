...
export default function IntroSequence() {
  ...
  return (
    <>
      {showLogo && (
        <div className={`fixed inset-0 z-30 flex items-center justify-center -translate-y-6 ${logoFading ? "fade-out-700" : "fade-in-1s"}`}>
          <div className="flex flex-col items-center text-center px-4">
            <Image
              ...
              height={200}
              priority
              className="fade-in-3s -mt-6 mb-1"
            />
            <p className="fade-in-delayed text-white/90 text-[14px] sm:text-[14px] leading-snug whitespace-pre-line text-center">
              네모나게 갇힌 세상 속,<br />
